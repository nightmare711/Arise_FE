				...
				<div className='box-4-content'>
					<div className='table-score'>
						...
						<div className='txt-extra'>
							...
							<br /> 1: 1 Legend NFT <br /> 2: 1 Epic NFT <br /> 3: 1 Rare NFT <br /> 4 ~ 10: 7 rare
							NFTs
						</div>
					</div>
					<div className='txt-frame'>
						...
						<span className='txt'>
							The winners will be top participants on the leaderboard with the highest scores by the
							end of every week.
						</span>
